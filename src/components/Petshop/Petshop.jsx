    ...
    return (
        <>
            <div className="petshop-card">
                ...
                {image && <img className="p-20 sm:p-4" src={image} />}
                ...
                <div className="grid gap-1">
                    {bio.map((content, index) => <p key={index} className="text-gray-900 dark:text-gray-300 line-clamp-1 sm:line-clamp-none">{content}</p>)}
                </div>
            </div>
        </>
    )
